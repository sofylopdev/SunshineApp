...
//      TODO (7) Display the weather icon using mDetailBinding
        ...
        mDetailBinding.primaryWeatherInfo.iconWeather.setImageResource(weatherImageId);
...
//      TODO (15) Create the content description for the description for a11y
        ...
        mDetailBinding.primaryWeatherInfo.weatherDescription.setContentDescription(descriptionAlly);
...
//      TODO (16) Set the content description of the icon to the same as the weather description a11y text
        mDetailBinding.primaryWeatherInfo.iconWeather.setContentDescription(descriptionAlly);
