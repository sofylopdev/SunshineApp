...
//  TODO (3) Add a Context field to the constructor and store that context in mContext
    ...
    public ForecastAdapterViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        //setFocusable -> enable/disable view's focus event on both touch mode and keypad mode(using up/down/next key).
...
//      TODO (5) Delete the current body of onBindViewHolder
       ...
       /* String dateString = SunshineDateUtils.getFriendlyDateString(
                mContext,mCursor.getInt(mCursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_DATE)),
                true
        );
        ...
        String highAndLowTemperature = SunshineWeatherUtils.formatHighLows(mContext,
...
//      TODO (10) If mCursor is null, return 0. Otherwise, return the count of mCursor
     ...
     *
     * @para m weatherData The new weather data to be displayed.
     */
