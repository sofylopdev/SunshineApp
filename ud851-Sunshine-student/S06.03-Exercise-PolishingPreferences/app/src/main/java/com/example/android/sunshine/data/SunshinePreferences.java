...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        return sp.getString(key, defaultLocation);//getDefaultWeatherLocation();
    }
    ...
    public static boolean isMetric(Context context) {
        ...
        if (sp.getString(key, defaultMetric).equals(context.getString(R.string.pref_units_metric))) {
            //eles puseram( (context.getString(R.string.pref_units_metric)).equals(sp.getString(key, defaultMetric))
            return true;
        }else return false;
    }
