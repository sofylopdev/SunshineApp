...
//      TODO (7) Replace the single TextView with Views to display all of the weather info
        ...
        int iconForWeatherCondition = SunshineWeatherUtils.getSmallArtResourceIdForWeatherCondition(weatherId);
        //weatherImageId

        forecastAdapterViewHolder.weatherIcon.setImageResource(iconForWeatherCondition);
        ...
        forecastAdapterViewHolder.maxTemperature.setText(highString);
         /* Create the accessibility (a11y) String from the weather description */
        String highA11y = mContext.getString(R.string.a11y_high_temp, highString);
        forecastAdapterViewHolder.maxTemperature.setContentDescription(highA11y);

        String lowString = SunshineWeatherUtils.formatTemperature(mContext, lowInCelsius);
        String lowA11y = mContext.getString(R.string.a11y_low_temp, lowString);
        forecastAdapterViewHolder.minTemperature.setContentDescription(lowA11y);
        forecastAdapterViewHolder.minTemperature.setText(lowString);
