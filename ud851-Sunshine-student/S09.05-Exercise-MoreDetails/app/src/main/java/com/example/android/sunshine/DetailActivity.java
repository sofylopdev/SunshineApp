...
//      TODO (13) Find each of the TextViews by ID
        ...
        mHighTemp = (TextView) findViewById(R.id.tv_display_high_temp);
        mLowTemp = (TextView) findViewById(R.id.tv_display_low_temp);
...
//          TODO (23) If the loader requested is our detail loader, return the appropriate CursorLoader
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        String humdtString =getString(R.string.format_humidity, humidity);
        mHumidity.setText(humdtString);
